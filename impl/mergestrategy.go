...
func doLookup(s merger, vs interface{}, ic lookup.Invocation, vf func(l interface{}) px.Value) px.Value {
...
func (d *firstFound) Lookup(vs interface{}, ic lookup.Invocation, f func(location interface{}) px.Value) px.Value {
	vsr := reflect.ValueOf(vs)
	if vsr.Kind() != reflect.Slice {
		return nil
	}
...
func (d *unique) Lookup(vs interface{}, ic lookup.Invocation, f func(location interface{}) px.Value) px.Value {
...
func (d *deepMerge) Lookup(vs interface{}, ic lookup.Invocation, f func(location interface{}) px.Value) px.Value {
	return doLookup(d, vs, ic, f)
}
...
func (d *hashMerge) Lookup(vs interface{}, ic lookup.Invocation, f func(location interface{}) px.Value) px.Value {
	return doLookup(d, vs, ic, f)
}
